...
import { InstagramSectionFragmentDoc } from "@/graphql/types/graphql";
...
type Props = {
  fragment: FragmentType<typeof InstagramSectionFragmentDoc>;
};
...
const InstagramSection = ({ fragment }: Props) => {
  const { heading, details } = getFragmentData(
    InstagramSectionFragmentDoc,
    fragment
  );
  ...
  return (
    <Box id="instagram-section-cta" position="relative" ref={ref}>
      <MotionBox
        position="absolute"
        inset={0}
        zIndex={0}
      ...
      >
        ...
        >
          ...
          <GridItem w="100%">
            <InstagramEmbed url="https://www.instagram.com/laistriasadvocacia/" />
          </GridItem>
        </Grid>
      </Container>
    </Box>
